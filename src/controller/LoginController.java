...
public class LoginController extends Controller<League> {
    ...
    private void handleKeyRelease() {
        ...
        /*Debugging*/ System.out.println(containsText);
    ...
    private void handleLogin() {
        ...
        try {
            ...
            /*Debugging*/ System.out.println("Login successful for manager ID: " + managerId);
            stage.close();
